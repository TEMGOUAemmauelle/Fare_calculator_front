...
export default function StatsPage() {
  ...
  // Composant Carte Horizontale Affiné
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-[#141414] overflow-x-hidden relative pb-20">
      ...
      >
        ...
        {/* 2. Hero Section: Lieu du Mois - REVISITÉ */}
        {stats.lieu_du_mois && (
      ...
      {/* Modal de Filtres (Bottom Sheet) - ACCORDÉ AU RESTE */}
      <AnimatePresence>
        {showFilterModal && (
          <>
            <motion.div 
            ...
            <motion.div 
              ...
              className="fixed bottom-0 left-0 right-0 bg-white rounded-t-4xl z-70 border-t border-gray-100 p-8 pb-12 shadow-2xl"
            >
              <div className="w-12 h-1 bg-gray-100 rounded-full mx-auto mb-8 cursor-pointer" onClick={() => setShowFilterModal(false)} />
              ...
              <div className="flex justify-between items-center mb-8">
                ...
                <button onClick={() => setShowFilterModal(false)} className="p-2 bg-gray-50 rounded-xl">
                ...
                {[
                  ...
                  <button
                    ...
                    className={`w-full p-4 rounded-2xl flex items-center gap-4 transition-all ${
                      period === option.id 
                        ? 'bg-[#141414] text-white shadow-xl shadow-gray-300' 
                        : 'bg-gray-50 text-gray-400 hover:bg-gray-100'
                    }`}
                  >
                    <div className={`p-2 rounded-xl ${period === option.id ? 'bg-[#f3cd08] text-black' : 'bg-white'}`}>
