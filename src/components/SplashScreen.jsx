                            ...
                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] animate-pulse">
                               ...
                               {status === 'error' && (
                                    <div className="flex flex-col items-center gap-3">
                                        ...
                                        <p className="text-[9px] font-semibold text-gray-500 bg-gray-50/80 px-3 py-1.5 rounded-full text-center">
                                           {message}
                                        </p>
                                        <div className="flex gap-4 pt-0.5">
                                           ...
                                           <button onClick={onSkip} className="text-[10px] font-black text-gray-400">
                                              {t('splash.skip')}
                                           </button>
                                        </div>
                                    </div>
